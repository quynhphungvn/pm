	...
	<div id="main-wrapper" class="d-flex">
      ...
      <div id="canvas-diagram" class="offcanvas" data-location="right" data-width="400px">
        <div class="offcanvas__content">
            <header>
                <h3 class="offcanvas__title">Class Diagram</h3>
                <button class="ui button p-2" type="button" onclick="hideOffCanvas('#canvas-diagram')">
                  <i class="close icon"></i>
                </button>
            </header>
            <main>
              <form method="post" action="/PM/domain/update-class"
              		class="ui form p-4" >   
              	<input type="hidden" name="domain-id" value="${selectedDomain.id}" >           
                <div class="field">
                  <label>Diagram</label>
                  <textarea rows="35" name="class-diagram">${selectedDomain.classDiagram}</textarea>
                </div>
                <div class="actions">
                  <div class="d-flex justify-content-start">
                    <button type="button" class="ui icon button" onclick="testClassDiagram(${selectedDomain.id})">
                    	<i class="sync icon"></i>
                    </button>
                  </div>
      ...
      <header class="d-flex align-items-center">
        <h3 class="ms-5 text-primary">CLASSES</h3>
      </header>
